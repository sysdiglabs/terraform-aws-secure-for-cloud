...
| <a name="input_ecs_ecs_vpc_region_azs"></a> [ecs\_ecs\_vpc\_region\_azs](#input\_ecs\_ecs\_vpc\_region\_azs) | Explicit list of availability zones for ECS VPC creation. eg: ["apne1-az1", "apne1-az2"]. If left empty it will be defaulted to two from the default datasource | `list(string)` | `[]` | no |
