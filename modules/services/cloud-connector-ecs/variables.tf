...
variable "sqs_name" {
  type        = string
  description = "Name of a pre-existing SQS queue where events will be published"
}

variable "config" {
  default     = ""
  type        = string
  description = "Configuration for the cloud-connector, if not specified it will be autogenerated"
}
