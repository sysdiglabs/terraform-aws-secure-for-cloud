...
# TODO(iru): make these two variables optional or default value null, does not make sense without scanning enabled
...
#
# cloudtrail-sns-sqs deployment
#
variable "deploy_sqs" {
  type        = bool
  default     = true
  description = "true/false whether to create the cloudtrail sns-sqs subscription"
}

#
# cloud-connector module config
#
variable "config" {
  type        = string
  default     = null
  description = "JSON-format configuration for the cloud-connector, if not specified it will be autogenerated"
}
