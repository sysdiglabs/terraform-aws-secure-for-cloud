...
| <a name="input_config"></a> [config](#input\_config) | JSON-format configuration for the cloud-connector, if not specified it will be autogenerated | `string` | `null` | no |
...
| <a name="input_deploy_sqs"></a> [deploy\_sqs](#input\_deploy\_sqs) | true/false whether to create the cloudtrail sns-sqs subscription | `bool` | `true` | no |
...
| <a name="input_guarduty_sqs_arn"></a> [guarduty\_sqs\_arn](#input\_guarduty\_sqs\_arn) | Optional. Experimental. ARN of the guardduty-sqs | `string` | `null` | no |
