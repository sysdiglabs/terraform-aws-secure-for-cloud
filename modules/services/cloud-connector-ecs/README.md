...
| <a name="input_sqs_name"></a> [sqs\_name](#input\_sqs\_name) | Name of a pre-existing SQS queue where events will be published | `string` | n/a | yes |
...
| <a name="input_config"></a> [config](#input\_config) | Configuration for the cloud-connector, if not specified it will be autogenerated | `string` | `""` | no |
