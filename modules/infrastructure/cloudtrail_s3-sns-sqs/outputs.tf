output "cloudtrail_subscribed_sqs_url" {
  value       = module.cloudtrail_s3_sns_sqs.cloudtrail_sns_subscribed_sqs_url
  description = "URL of the SQS topic subscribed to the SNS of Cloudtrail-S3 bucket"
}
