...
| [aws_sns_topic_policy.allow_cloudvision_subscribe](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sns_topic_policy) | resource |
| [aws_caller_identity.me](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/caller_identity) | data source |
| [aws_iam_policy_document.cloudtrail_cloudvision](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_organizational_setup"></a> [organizational\_setup](#input\_organizational\_setup) | whether organization\_trail setup is to be enabled. if true, cloudvision\_member\_account\_id must be given, to enable reading permission | <pre>object({<br>    is_organization_trail             = bool<br>    org_cloudvision_member_account_id = string<br>  })</pre> | <pre>{<br>  "is_organization_trail": false,<br>  "org_cloudvision_member_account_id": null<br>}</pre> | no |
