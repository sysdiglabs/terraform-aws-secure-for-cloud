...
2. Retrieve your `<SYSDIG_SECURE_ENDPOINT>` and `<SYSDIG_SECURE_API_TOKEN>`.
...
3. Use the [Sysdig cloud-connector helm chart](https://charts.sysdig.com/charts/cloud-connector/) to Locate your `<SYSDIG_SECURE_ENDPOINT>` and `<SYSDIG_SECURE_API_TOKEN>`.
